...
export const ProjectsData = [
  ...
  },
  {
    ...
    description:
      "Projeto desenvolvido durante o evento NLW eSports, utilizando ReactJS, TailwindCSS, NodeJS, Express, Prisma, e outras tecnologias.",
  ...
  },
  {
    ...
    description:
      " Pesquise pelo seu perfil do GitHub!! Projeto desenvolvido em React e TailwindCSS.",
  ...
  },
  {
    ...
    description:
      "Lista de Filmes mais populares do momento, consumindo dados da Api do The Movie DB. Desenvolvido em ReactJS.",
  ...
  },
  {
    ...
    description:
      "Projeto desenvolvido em ReacJS com Typescript, TailwindCSS, e conexão com banco de dados Cloud Firestore do Firebase!",
  ...
  },
  {
    ...
    image: MoveItImage,
    description:
      " Projeto desenvolvido no evento NLW 4 da Rocketseat, utilizando NextJS e outras tecnologias.",
