...
export const ProjectItem = ({
  ...
  return (
    <div
      className="w-[300px] md:w-[350px] lg:w-[380px] h-[500px]  dark:bg-[#27303d] p-5 m-auto my-10 flex flex-col justify-evenly items-center shadow-2xl rounded-xl hover:scale-105 ease-in duration-300 hover:cursor-pointer
    "
    >
